class RscDisplayLicenseShop 
{
	...
	class controls
	{
		class OwnedLicensesTitle : RscDefineText 
		{  
			idc = -1;
			text = "Owned Licenses";
			x = 0.65;  
		...
		class OwnedLicenses: RscDefineStructuredText 
		{
			idc = 55131;  
			text = "";
			sizeEx = 0.035;
		...
		class AvailableLicenses: RscDefineListBox 
		{
			idc = 55126; 
			text = "";
			sizeEx = 0.035;  
		...
		class Closebutton: RscDefineButtonMenu 
		{
			idc = -1;
