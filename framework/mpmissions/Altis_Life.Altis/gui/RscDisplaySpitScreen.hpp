class RscDisplaySpitScreen
{
	...
	duration = 10e10;
  	fadeout=0;
	name="RscDisplaySpitScreen";
	onLoad = "uiNamespace setVariable ['RscDisplaySpitScreen',_this select 0]";
	onUnload = "uiNamespace setVariable ['RscDisplaySpitScreen', objNull]";
	onDestroy = "uiNamespace setVariable ['RscDisplaySpitScreen', objNull]";
	objects[]={};
