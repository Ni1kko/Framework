...
class RscDefineCheckboxStyle2 : RscDefineCheckbox
{
    idc = -1;
    type = 7;
    style = 0;
...
class RscDefineControlsGroup 
{
    ...
    class VScrollBar : RscDefineScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : RscDefineScrollBar
    {
        height = 0.028;
    };
...
class RscDefineControlsGroupNoScrollbars : RscDefineControlsGroup 
{
...
class RscDefineListNBox
{
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: RscDefineScrollBar{};
    class ScrollBar: RscDefineScrollBar{};
};
...
class RscDefineTitle: RscDefineText 
{
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
