...
lbClear _units;
CONTROL(2700,2701) ctrlSetStructuredText parseText format ["<img size='1.7' image='icons\ico_bank.paa'/> $%1<br/><img size='1.6' image='icons\ico_money.paa'/> $%2",[life_var_bank] call life_fnc_numberText,[life_var_cash] call life_fnc_numberText];
