...
if (life_var_cash > 0) then {
    ...
    [1,"STR_NOTF_Robbed",true,[_robber getVariable ["realname",name _robber],profileName,[life_var_cash] call MPClient_fnc_numberText]] remoteExecCall ["MPClient_fnc_broadcast",RE_CLIENT];
