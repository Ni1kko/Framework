...
_mstatus ctrlSetStructuredText parseText format ["<img size='1.3' image='textures\icons\ico_bank.paa'/> <t size='0.8px'>$%1</t><br/><img size='1.2' image='textures\icons\ico_money.paa'/> <t size='0.8'>$%2</t>",[life_var_bank] call MPClient_fnc_numberText,[life_var_cash] call MPClient_fnc_numberText];
