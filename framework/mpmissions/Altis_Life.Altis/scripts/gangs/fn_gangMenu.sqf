...
if (isNull (findDisplay 2620)) then {
    if (!(createDialog "RscDisplayGang")) exitWith {}; //NOOOOOOOOOOOOOOOOOOOOOOOoooooooooooooOOOOOOOOOOOOOOOOOOOOOOOOOOO00000000000000oooooo
};
...
(CONTROL(2620,601)) ctrlSetText format [(localize "STR_GNOTF_Funds")+ " $%1",[_gangBank] call MPClient_fnc_numberText];
