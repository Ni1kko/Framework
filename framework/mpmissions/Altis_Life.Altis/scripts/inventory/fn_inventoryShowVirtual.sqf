...
if(_isKindOfVehicle AND (_inVehicle OR _isCloseEnough)) then {
   _modes pushBackUnique "Vehicle";
};
...
//-- Handle our controls
{
    ...
    { 
        ...
        { 
            ...
            _control ctrlAddEventHandler ["LBListSelChanged", "_this call MPClient_fnc_inventoryVirtualComboSelChanged"];
        }else{
            //-- Menu Title
            ...
            { 
                ...
                { 
                    ...
                    if (_idc isEqualTo 77710) then
                    {
                        ...
                        _control ctrlRemoveAllEventHandlers "LBListSelChanged";
                        _control ctrlAddEventHandler ["LBListSelChanged", "call spawn MPClient_fnc_inventoryVirtualPlayersComboSelChanged"]; 
                    }else{
                            ...
                            { 
                                switch _idc do
                                {
                                    ...
                                    case 77711: 
                                    {
                                        ...
                                        _control ctrlEnable (ctrlEnabled (_ctrlParent displayCtrl 77710));
                                    };
                                    case 77713: 
                                    {
                                        private _text = "Store";
                                        ...
                                        _control ctrlRemoveAllEventHandlers "ButtonClick";
                                        _control ctrlAddEventHandler ["ButtonClick", "_this call MPClient_fnc_inventoryVirtualMoveItemToVehicle"];
                                        _control ctrlEnable (_isKindOfVehicle AND (_inVehicle OR _isCloseEnough));
                                        _control ctrlShow true;
                                    };
                                };
                            };
                            case "Vehicle": 
                            {
                                switch _idc do
                                {
                                    ...
                                    { 
                                        ...
                                        _control ctrlSetToolTip format["%1 selected item", toLower _text];
                                        _control ctrlRemoveAllEventHandlers "ButtonClick";
                                        _control ctrlAddEventHandler ["ButtonClick", "_this call MPClient_fnc_inventoryVirtualVehicleUseItem"];
                                        _control ctrlEnable (_isNotBeingUsed AND _isKindOfVehicle AND (_inVehicle OR _isCloseEnough));
                                        _control ctrlShow true;
                                    };
                                    case 77708: 
                                    {
                                        ...
                                        _control ctrlRemoveAllEventHandlers "ButtonClick";
                                        _control ctrlAddEventHandler ["ButtonClick", "_this call MPClient_fnc_inventoryVirtualVehicleTakeItem"];
                                        _control ctrlEnable (_isNotBeingUsed AND _isKindOfVehicle AND (_inVehicle OR _isCloseEnough));
                                        _control ctrlShow true;
                                    };
