...
_str = M_CONFIG(getText,"cfgVirtualItems","goldbar","displayName");
_shrt = M_CONFIG(getText,"cfgVirtualItems","goldbar","variable");
_tInv lbAdd format ["[%1] - %2",_safeInfo,TEXT_LOCALIZE(_str)];
_tInv lbSetData [(lbSize _tInv)-1,_shrt];
_icon = M_CONFIG(getText,"cfgVirtualItems","goldbar","icon");
