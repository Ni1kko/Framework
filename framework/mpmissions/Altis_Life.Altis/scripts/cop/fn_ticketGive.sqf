...
[0,"STR_Cop_TicketGive",true,[profileName,[(parseNumber _val)] call MPClient_fnc_numberText,life_ticket_unit getVariable ["realname",name life_ticket_unit]]] remoteExecCall ["MPClient_fnc_broadcast",RCLIENT];
