...
_gangName = [_gangName] call MPServer_fnc_mresString;
...
_queryResult = [_query,2] call MPServer_fnc_database_rawasync_request;
_gangMembers = [[_uid]] call MPServer_fnc_mresArray;
...
_queryResult = [_query,1] call MPServer_fnc_database_rawasync_request;
